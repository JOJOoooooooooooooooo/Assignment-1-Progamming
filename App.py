...
while Choice3 == 0:
    ...
    if userchoice3 == "1":
        ...
        if isinstance(Myclass, adventureclass.Human):
            ...
            print("_______________________________________________________________________________________________________\n")
            print("                           Tres is suddenly struck by lightning")
            input("_______________________________________________________________________________________________________\n")
            ...
            input("_______________________________________________________________________________________________________\n")
            input("ELF KING ALGIAR: Hello my comrades, I sensed you where in a pickle and decided to lend some aid, an old trick I learned from dealing with Devils Greed... I've cured Tres no need worry about him, focus your strengths on fightingthe dragon!")
            input(playername + ": Phew just in the neck of time, I was running out of ideas...")
            input("ELF GENERAL SVEN: That's why I serve his higness!")
            ...
            input("JOJO: You had sucumb to the devils greed sickness, " + playername + " distracted while the elf king cured you")
            input("ELF GENERAL SVEN: My lord really is something!-")
            ...
            input("DOS: I LOVE IT")
            input("ELF GENERAL SVEN: Even the elven Gods would not have seen that one coming")
            ...
            print("")
            input("ELF GENERAL SVEN: I never thought id see him again...")
            ...
            while Myclass.health > 0 and DragonStunna.health > 0:
                if Roll in [1,7]:
                    ...
                    damage = Myclass.attack + LostDwarves.attack + ElfGeneral.attack
                    print(playername + " and party Attacks!")
                    DragonStunna.health -= damage
                    print("DRAGON STUNNA'S Health:", DragonStunna.health)
                    if DragonStunna.health <= 0:
            ...
            input("ELF KING ALGIAR: By the Heavens you've done it! Congratualtions my subordinates!")
            input("ELF GENERAL SVEN: Thank you My lord")
            input("TRES: IT'S FINALLY DONE, THANK YOU SVEN, JOJO AND " + playername + " WE COULDNT HAVE GOTTEN THIS FAR WITHOUT YOU ALL ")
            ...
            print("JOJO: We have no other choice, go for it " + playername)
            print(playername + ": You have to snap out of it Tres!, You remember me, you know I feel your pain, dont do this to your brothers, they've fought so hard to Make it to this point with you")
            ...
            while z == 0:
                if Roll == 1:
                    ...
                    print("                           Tres is suddenly struck by lightning")
                    input("_______________________________________________________________________________________________________\n")
                    print(playername + ": Whats Going on?")
                    input("ELF KING ALGIAR: Hello my comrades, I sensed you where in a pickle and decided to lend some aid, an old trick I learned from dealing with Devils Greed but it seems you actually got to him before I did!... I've helped cured Tres no need worry about him, focus your strengths on fightingthe dragon!")
                    print("_______________________________________________________________________________________________________\n")
                    print("                            Tres falls to the floor ")
                    input("_______________________________________________________________________________________________________\n")
                else:
                    print(playername + ": Its not working Try again")
                    Roll = random.randint(1,2)
                    input(" Press Enter to Roll Dice ")

                    print("The Dice lands on... " + color.BOLD + str(Roll) + color.END)

            input(playername + "It's Okay Tres Im here for you")
            input("JOJO: I cant believe it! I've never in all my years seen a hobbit help cure the Devils Greed Sickness without magic, you truly are a special one " + playername + "Im glad I never doubted you for a second")
            input(playername + ": Thank you JOJO")
            input("ELF GENERAL SVEN: You're almost as impressive as his highness " + playername + " !")
            input("UNO: TRES!")
            input("DOS: BROTHER!!")
            input("TRES: IM OKAY BROTHER'S I JUST NEED SOME REST... THANK YOU " + playername + "FOR STOPPING ME BEFORE SOMETHING BAD HAPPEND")
            input(playername + ": Dont mention it Tres!")
            input("JOJO: Okay brother's rest up, for now we must prepare to fight the Calamitous Stunna! and reclaim your home!")
            input("EVERYONE: HUZAAAHHHHH!!! ")
            print("\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
            print("                                              3 HOURS LATER\n")
            input("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n\n")
            ...
            input("UNOS: HES RIGHT WE MUST DO THIS")
            input("DOS: IS THERE NO OTHER WAY?")
            input("UNOS: ....")
            input(playername + ": ... ")
            input("DOS: I WILL DO IT.")
            input("JOJO: If this is the path you all chose I will not stand in your way...")
            input("ELF GENERAL SVEN: Neither Will I...")
            input("TRES: RAAAHHHH FIGHT ME!!")
            input(playername + ": I will give you a proper burial Tres")
            input("JOJO: The tragedy of the devils greed sickness...")
            print("_______________________________________________________________________________________________________\n")
            print("                           Tres is suddenly struck by lightning")
            input("_______________________________________________________________________________________________________\n")
            print(playername + ": Whats Going on?")
            input("ELF KING ALGIAR: Hello my comrades, I sensed you where in a pickle and decided to lend some aid, an old trick I learned from dealing with Devils Greed ... I've helped cured Tres no need worry about him, focus your strengths on fightingthe dragon!")
            print("_______________________________________________________________________________________________________\n")
            print("                            Tres falls to the floor ")
            input("_______________________________________________________________________________________________________\n")
            input("DOS: THANK THE HEAVENS!!")
            input("UNO: I COULDNT BARE TO GO THROUGH WITH IT")
            input("JOJO: You saved us your highness without you I dont kno what we would've done")
            input("ELF GENERAL SVEN: Thats the magnificent power of his highness for ya!")
            input("JOJO: Okay brother's rest up, for now we must prepare to fight the Calamitous Stunna! and reclaim your home!")
            input("EVERYONE: HUZAAAHHHHH!!! ")
            print("\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
            print("                                              3 HOURS LATER\n")
            ...
            input("JOJO: Good idea, while you trap him I can figure out a potential cure for the sickness!")
            input("UNO: LUCKY FOR US THERES A JAIL CELL RIGHT HERE!")
            input("DOS: ILL TRICK HIM INTO GOING INSIDE AND DISTRACTR HIM, YOU " + playername + " FIND THE KEY AND LOCK IT")
            input("ELF GENERAL SVEN: I will help you Dos!")
            input(playername + ": got it")
            input("DOS: Yoooo Hooooo TRES! OVER HERE! ILL FIGHT YOU!, YOU GOTTA CATCH ME FIRST THOUGH!")
            input("ELF GENERAL SVEN: YEAH TRY AND CATCH US!")
            input("TRES: YOU PESKY RUNTS GET OVER HEREEEE")
            print("_______________________________________________________________________________________________________\n")
            print("                                 Tres falls for the trap and ends up in the jail cell")
            input("_______________________________________________________________________________________________________\n")
            input("UNO: LOCK IT NOW")
            input(playername + ": GOT IT")
            print("_______________________________________________________________________________________________________\n")
            print("                           Tres is suddenly struck by lightning")
            input("_______________________________________________________________________________________________________\n")
            ...
            print("                            Tres falls to the floor ")
            input("_______________________________________________________________________________________________________\n")
            input("JOJO: Thank you your higness I had no idea how I was going to save Tres!")
            input("ELF GENERAL SVEN: Thats his highness for ya!")
            input("JOJO: Good work brothers! clear your minds, by the time we must fight Tres will be with us")
            input("JOJO: Its time to reclaim the Dwarves home!")
            input("EVERYONE: HUZZZAAAA")
            print("\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
            print("                                              3 HOURS LATER\n")
            input("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n\n")
            input("JOJO: It's time Brothers, grab your equipment and lets make our way to the treasurery!")
        ...
        if isinstance(Myclass, adventureclass.Human):
            ...
            while z == 0:
                if Roll == 1:
                    z = z +1
                    print("TRES: AGHH WHAT HAPPEND TO ME, WHY DO I FEEL LIKE SOMEONE ELSE WAS IN MY BODY.. IN MY SKIN")
                else:
                    print(playername + ": Its not working Try again")
                    Roll = random.randint(1,2)
                    input(" Press Enter to Roll Dice ")
            ...
            input(playername + "It's Okay Tres Im here for you")
            input("JOJO: I cant believe it! I've never in all my years seen a hobbit cure the Devils Greed Sickness without magic, you truly are a special one " + playername + "Im glad I never doubted you for a second")
            input(playername + ": Thank you JOJO")
            input("UNO: TRES!")
            input("DOS: BROTHER!!")
            input("TRES: IM OKAY BROTHER'S I JUST NEED SOME REST... THANK YOU " + playername + "FOR STOPPING ME BEFORE SOMETHING BAD HAPPEND")
            ...
            Tres = adventureclass.Tres()

            input(" Press Enter to Roll Dice ")

            print("The Dice lands on... " + color.BOLD + str(Roll) + color.END)

            while Myclass.health > 0 and Tres.health > 0:
                if Roll in [1,7]:
                    damage = 0.7 * Tres.health
                    formatted_damage = "{:.2f}".format(damage)
                    print(playername + " and party uses RADIANT SPARK")
                    Tres.health -= damage
                    print("BROTHER TRES'S health:", Tres.health)

                    if Tres.health <= 0:
                     print("You have freed Tres's soul")
                    elif Tres.health > 0:
                        Roll = random.randint(1,10)
                        input(" Press Enter to Roll Dice ")
                        input("The Dice lands on... " + color.BOLD + str(Roll) + color.END)
                    ...
                    if Myclass.health <= 0:
                        ...
                        input(" Press Enter to Roll Dice ")
                        input("The Dice lands on... " + color.BOLD + str(Roll) + color.END)
            print(playername + ": Its over I promised id give you a proper burial, Goodbye Tres")
            print("Tres: Im... Im... Sorry")
            print("UNO: GOODBYE BROTHER....")
            print("DOS:....")
            print("JOJO: I am sorry that he could not make it to see us defeat the Calamitous Dragon Stunna, but we should not let Tres's death be in vein, Clear your minds and get ready for we shall Recaim the dwarven Kingdom!")
            print("EVERONE: FOR TRES!!")
            print("\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
            print("                                              3 HOURS LATER\n")
            input("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n\n")
            input("JOJO: It's time Brothers, grab your equipment and lets make our way to the treasurery!")
            ...
            input(playername + " : What a fearsome foe, I wont back down, FOR TRES!")
            ...
            input("DOS: IM TEARING UP")
            input("JOJO: You asked for my help and with the companionship of " + playername + "we have reclaimed your home")
            input(playername + "I am so grateful to have gone on this adventure with you all, im so happy we did it! im sure Tres's is watching us and celebreating as we speak!")
            input("UNO: YOU MUST STAY FOR CELEBREATION, ITS WHAT TRES WOULD WANT, COME FEAST WITH US, STAY AS LONG AS YOU WANT! YOU " + playername + "AND JOJO ARE OUR CHAMPIONS")
            input("JOJO: yes " + playername + " I will aid you back to your home once we have finished our clebration so for now enjoy yourself, for without you we couldnt have done it")
            input("EVERYONE: HUZZAAAHHH")
            print("\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~| --------------------- |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
            print("><><><><><>><><><><><><><><><><><><<><><><| END OF THE HOPPIT |<><><><><><><><><><><><><><><><><><><><><\n")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~| --------------------- |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n\n")
            print("                           /\ ")
            ...
            input(playername + ": got it")
            input("DOS: Yoooo Hooooo TRES! OVER HERE! ILL FIGHT YOU!, YOU GOTTA CATCH ME FIRST THOUGH!")
            input("TRES: YOU PESKY RUNT GET OVER HEREEEE")
            print("_______________________________________________________________________________________________________\n")
            print("                                 Tres falls for the trap and ends up in the jail cell")
            input("_______________________________________________________________________________________________________\n")
            input("UNO: LOCK IT NOW")
            input(playername + ": GOT IT")
            input("JOJO: Good work brothers! It seems I may have found a way to cure Tres as well it will take some time and a lot of magic so in the meantime clear your minds, by the time we must fight Tres will be with us")
            input("JOJO: Its time to reclaim the Dwarves home!")
            input("EVERYONE: HUZZZAAAA")
            ...
            print("                                              3 HOURS LATER\n")
            input("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n\n")
            input("TRES: huh... whats going on?... why do I feel like someone else has been using my body?")
            input("JOJO: ah so you've awakened, You where cursed with Devils Greed but because of " + playername + " : we where able to cure you in time!")
            input("TRES: to think an elf would save my life.... after everything...")
            input("JOJO: You can thank him later for now its time to kill Stunna!")
            input("JOJO: It's time Brothers, grab your equipment and lets make our way to the treasurery!")
            input("\n\n<>-<>-<>-<>-<>-<>-<>-<>-<>-<>-<>-<>-<>-<>-| DWARVEN ARMOUR AND WEAPONS AQUIRED |-<>-<>-<>-<>-<>-<>-<>-<>-<>-<>-<>-<>-<>-<>\n\n")
            print("_______________________________________________________________________________________________________\n")
            print("                            party Health and Attack Stats Increased by 5 ")
            ...
            input("JOJO: You asked for my help and with the companionship of " + playername + "we have reclaimed your home")
            input(playername + "I am so grateful to have gone on this adventure with you all, im so happy we did it!")
            input("TRES: ANYTHING IN THIS KINGDOM IS YOURS JOJO AND " + playername + "FEEL FREE TO STAY AS LONG AS YOU LIKE, YOU'VE HELPED ME AND MY BROTHERS SO MUCH EVEN THOUGH YOU'RE AN ELF I CANNOT THANK YOU ENOUGH")
            input("JOJO: yes " + playername + " I will aid you back to your home once we have finished our clebration so for now enjoy yourself, for without you we couldnt have done it")
            print("\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~| --------------------- |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
            print("><><><><><>><><><><><><><><><><><><<><><><| END OF THE HOPPIT |<><><><><><><><><><><><><><><><><><><><><\n")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~| --------------------- |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n\n")
